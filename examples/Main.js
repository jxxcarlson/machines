...
var author$project$ListMachine$applyReducerToMachineState = F3(
...
var author$project$ListMachine$initialInternalState = function (inputList) {
	return {
...
var author$project$ListMachine$initialMachineState = function (inputList) {
	return {
		internalstate: author$project$ListMachine$initialInternalState(inputList),
...
var author$project$ListMachine$applyReducer = F2(
	function (reducer, inputList) {
		var initialMachineState_ = author$project$ListMachine$initialMachineState(inputList);
		var finalState = A3(author$project$ListMachine$applyReducerToMachineState, reducer, initialMachineState_, inputList);
		return elm$core$List$reverse(finalState.outputList);
	});
var author$project$ListMachine$nextInternalState = function (internalState_) {
...
var author$project$ListMachine$makeReducer = F3(
	function (computeOutput, input, machineState) {
		var nextInternalState_ = author$project$ListMachine$nextInternalState(machineState.internalstate);
...
var author$project$ListMachine$run = F2(
	function (outputFunction, inputList) {
		return A2(
			author$project$ListMachine$applyReducer,
			author$project$ListMachine$makeReducer(outputFunction),
			inputList);
	});
var author$project$Main$inputStringList = _List_fromArray(
	['He', 'said', ',', 'Wow', '!']);
...
var author$project$Main$line = function (str) {
...
var author$project$Main$outputValue = function (internalState) {
	var c = A2(elm$core$Maybe$withDefault, 0, internalState.after);
	var b = A2(elm$core$Maybe$withDefault, 0, internalState.current);
	var a = A2(elm$core$Maybe$withDefault, 0, internalState.before);
	return (a + b) + c;
};
var author$project$Main$EndParagraph = {$: 'EndParagraph'};
var author$project$Main$NoSpace = {$: 'NoSpace'};
...
var author$project$Main$stringJoiner = function (internalState) {
	var c = A2(elm$core$Maybe$withDefault, '', internalState.after);
	var symbol = _Utils_eq(internalState.after, elm$core$Maybe$Nothing) ? author$project$Main$EndParagraph : (A2(
		elm$core$List$member,
		A2(elm$core$String$left, 1, c),
		_List_fromArray(
			[',', ';', '.', ':', '?', '!'])) ? author$project$Main$NoSpace : author$project$Main$Space);
	var b = A2(elm$core$Maybe$withDefault, '', internalState.current);
	return _Utils_Tuple2(b, symbol);
};
var author$project$Main$stringJoiner2 = function (internalState) {
	var c = A2(elm$core$Maybe$withDefault, '', internalState.after);
	var b = A2(elm$core$Maybe$withDefault, '', internalState.current);
	var output = _Utils_eq(internalState.after, elm$core$Maybe$Nothing) ? (b + '\n\n') : (A2(
		elm$core$List$member,
		A2(elm$core$String$left, 1, c),
		_List_fromArray(
			[',', ';', '.', ':', '?', '!'])) ? b : (b + ' '));
...
var author$project$Main$test = F2(
	function (a, b) {
		return elm$html$Html$text(
			a + (': ' + (elm$core$Debug$toString(b) + '\n\n')));
	});
var author$project$Main$theInputList = _List_fromArray(
	[0, 1, 2, 3, 4]);
...
var author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			author$project$Main$line('TESTS:'),
			A2(author$project$Main$test, 'input', author$project$Main$theInputList),
			A2(
			author$project$Main$test,
			'output',
			A2(author$project$ListMachine$run, author$project$Main$outputValue, author$project$Main$theInputList)),
			A2(author$project$Main$test, 'str input', author$project$Main$inputStringList),
			A2(
			author$project$Main$test,
			'str output',
			A2(author$project$ListMachine$run, author$project$Main$stringJoiner, author$project$Main$inputStringList)),
			A2(
			author$project$Main$test,
			'str output2',
			A2(author$project$ListMachine$run, author$project$Main$stringJoiner2, author$project$Main$inputStringList)),
			A2(
			author$project$Main$test,
			'str output2b',
			A2(
